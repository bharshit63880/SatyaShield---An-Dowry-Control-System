  ...
  return <div className="page-shell py-10">
      ...
      textAlign: 'center'
        ...
        justifyContent: 'center'
          ...
          padding: '13px 28px',
          fontSize: '14px'
        }}>{t("visible.b93defa21851")}</Link>
          <Link to="/login" className="button-secondary" style={{
          padding: '12px 24px',
          fontSize: '14px'
        }}>{t("visible.090b368632eb")}</Link>
        </div>
